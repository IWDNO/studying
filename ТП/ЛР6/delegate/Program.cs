...
namespace IndustriaProduction
{
    ...
    public class Workshop
    {
        ...
        public Workshop(LogMessage logMessage)
        {
        ...
        {
            LogMessage("Запуск производства");
        ...
        {
            LogMessage("Остановка производста");
            foreach (Machine machine in machines)
            {
                machine.SetBusy(false);
            }
        ...
        {
            LogMessage("Проверка состояния производства");
    ...
    class Program
    {
        ...
        {
            LogMessage logger = Logger.Log;
            Workshop workshop = new Workshop(logger);
